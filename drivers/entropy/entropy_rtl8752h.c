 ...
 */
#define DT_DRV_COMPAT realtek_rtl8752h_trng
...
static int entropy_rtl8752h_trng_init(const struct device *dev)
{
	ARG_UNUSED(dev);
...
static const struct entropy_driver_api entropy_rtl8752h_trng_api_funcs = {
